...
um_call = copy.copy(call)
um_call.append('@{}/grib.ttl'.format(fpath))
um_call.append("http://{}/?status=Experimental".format(base))
print ' '.join(um_call)
subprocess.check_call(um_call)
print '\n\n'
...
um_call.append("http://{}/grib?status=Experimental".format(base))
print ' '.join(um_call)
subprocess.check_call(um_call)
print '\n\n'
...
um_call.append("http://{}/grib/core?batch-managed&status=Experimental".format(base))
print ' '.join(um_call)
subprocess.check_call(um_call)
print '\n\n'
...
um_call.append("http://{}/grib/grib2?status=Experimental".format(base))
print ' '.join(um_call)
subprocess.check_call(um_call)
print '\n\n'
...
um_call.append("http://{}/grib/grib2/codeflag?batch-managed&status=Experimental".format(base))
print ' '.join(um_call)
subprocess.check_call(um_call)
print '\n\n'
